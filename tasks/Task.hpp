...
#ifndef CAMERA_BB2_TASK_TASK_HPP
#define CAMERA_BB2_TASK_TASK_HPP
...
*/
    ...
    public:
         ...
         */
        Task(std::string const& name = "camera_bb2::Task");
	...
	~Task();
         ...
         */
        void deInterlace(const base::samples::frame::Frame &input, base::samples::frame::Frame &left, base::samples::frame::Frame &right);
